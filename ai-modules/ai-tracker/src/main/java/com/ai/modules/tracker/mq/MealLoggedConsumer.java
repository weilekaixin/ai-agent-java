...
@RocketMQMessageListener(
        topic = NutritionMqConstant.TOPIC_NUTRITION_EVENT,
        selectorExpression = NutritionMqConstant.TAG_MEAL_LOGGED,
        consumerGroup = NutritionMqConstant.GROUP_TRACKER_AGGREGATOR
)
